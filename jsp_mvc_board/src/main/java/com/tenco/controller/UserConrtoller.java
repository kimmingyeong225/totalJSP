...
import com.tenco.repository.interfaces.UserRepository;
import com.tenco.repository.interfaces.UserRepositoryImpl;

@WebServlet("/user/*")
public class UserConrtoller extends HttpServlet {
	private static final long serialVersionUID = 1L;

	// UserController --> UserRepositsory
